defmodule CalmdoWeb.Components.Modal do
  @moduledoc """
  The `CalmdoWeb.Components.Modal` module provides a versatile and customizable modal component for
  ...
  **Documentation:** https://mishka.tools/chelekom/docs/modal
  ...
  import CalmdoWeb.Components.Icon, only: [icon: 1]
